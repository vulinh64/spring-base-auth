...
VALUES ('00000000-0000-0000-0000-000000000020', 'user', 'user@localhost', 'Default', 'User', 'SYSTEM', 'SYSTEM', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
VALUES ('00000000-0000-0000-0000-000000000021', '00000000-0000-0000-0000-000000000020', 'PASSWORD', '$2a$12$EE6IeEdWWxtl50izsia3muO6cihnAlDi2nGswxCSp/mhF..5KB/zO', TRUE, 'SYSTEM', 'SYSTEM', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
INSERT INTO account (id, username, email, first_name, last_name, created_by, updated_by, created_date_time, updated_date_time)
VALUES ('00000000-0000-0000-0000-000000000022', 'admin-user', 'admin-user@localhost', 'Admin', 'User', 'SYSTEM', 'SYSTEM', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);

INSERT INTO account_credential (id, account_id, credential_type, metadata, enabled, created_by, updated_by, created_date_time, updated_date_time)
VALUES ('00000000-0000-0000-0000-000000000023', '00000000-0000-0000-0000-000000000022', 'PASSWORD', '$2a$12$EE6IeEdWWxtl50izsia3muO6cihnAlDi2nGswxCSp/mhF..5KB/zO', TRUE, 'SYSTEM', 'SYSTEM', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
