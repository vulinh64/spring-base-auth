...
INSERT INTO account (id, username, email, first_name, last_name, created_by, updated_by, created_date_time,
                     updated_date_time)
VALUES ('00000000-0000-0000-0000-000000000000', 'administrator', 'admin@localhost', 'Admin', 'User', 'SYSTEM', 'SYSTEM',
...
VALUES ('00000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000000', 'PASSWORD',
